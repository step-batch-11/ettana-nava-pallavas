export const isInBoundary = (x, y, rows, columns) => x <= rows && x >= 0 && y <= columns && y >= 0;
...
export const computeExpense = (distributionConfig) => Object.values(distributionConfig).reduce((a, b) => a + b, 0);
